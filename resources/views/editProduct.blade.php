                                    ...
                                    <form class="l-f-o__form" method="POST" id="myForm" enctype="multipart/form-data">
                                        ...
                                        <div class="u-s-m-b-30">
                                            <label class="gl-label" for="gender">CATEGORY</label><select
                                                ...
                                                <option value="Women" @if($pd->category === "Women")selected @endif>Women</option>
                                        ...
                                        <div class="u-s-m-b-30">
                                            ...
                                            <input class="input-text input-text--primary-style" type="text"
                                                id="productPrice" name="price" value="{{$pd->price}}" required/>
                                        </div>
                                        <div class="u-s-m-b-30">
                                            <label class="gl-label" for="reg-password">DESCRIPTION *</label>

                                            <textarea name="description1" id="text-area" cols="30" rows="40"
                                                value="" required>{!!$pd->description!!}</textarea>
