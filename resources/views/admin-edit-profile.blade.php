                                        ...
                                        <div class="dash__pad-1">
                                            ...
                                            <ul class="dash__f-list">
                                                <li>
                                                    ...
                                                    <a  href="admin-profile.html" class="dash-active">Manage My Account</a></li>
                                                <li>
                                                    <a href="admin-manage-product.html" >Manage Products</a></li>
                                                
                                                <li>

                                                    <a href="admin-manage-order.html">Manage Orders</a></li>
                                                    ...
                                                    <form class="dash-edit-p">
                                                        <div class="gl-inline">
                                                            <div class="u-s-m-b-30">
                                                                ...
                                                                <input class="input-text input-text--primary-style" type="text" id="reg-fname" placeholder="Joshua"></div>
                                                            <div class="u-s-m-b-30">

                                                                <label class="gl-label" for="reg-lname">LAST NAME *</label>

                                                                <input class="input-text input-text--primary-style" type="text" id="reg-lname" placeholder="Assidao"></div>
                                                        </div>
                                                        <div class="gl-inline">
                                                            <div class="u-s-m-b-30">
